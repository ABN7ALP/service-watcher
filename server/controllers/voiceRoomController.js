...
// حساب TURN مخصّصاً موثوقاً للإنتاج؛ بدونها يُستخدم احتياطي مجاني عام (Open Relay Project —
// بيانات اعتماد مشتركة منشورة رسمياً من مزوّدها metered.ca للاستخدام المفتوح بلا تسجيل).
// 🐛 هذا الاحتياطي المشترك ثبت عملياً أنه غير موثوق دائماً (سعته محدودة ومُتقاسَمة مع تطبيقات
// أخرى حول العالم تستخدم نفس بيانات الاعتماد العامة تماماً) — الحل الحقيقي طويل الأمد هو
// حساب TURN مخصّص مجاني بالكامل: التسجيل بـhttps://dashboard.metered.ca/signup يمنح 20GB
// مجاناً شهرياً بحساب خاص (لا مشاركة سعته مع أحد)، ثم تُضبَط متغيرات البيئة الثلاثة أعلاه
// بقيم ذاك الحساب على Railway — تغيير إعداد بحت، بلا أي تعديل كود إضافي مطلوب
// =====================================================
// ✅ تحذير مرة واحدة عند إقلاع الخادم (وليس بكل طلب) — يوضّح بسجلات Railway مباشرة هل هذي
// النسخة تعتمد على TURN مخصّص موثوق أو على الاحتياطي المجاني المشترك (Open Relay Project)
// الذي ثبت بالاختبار الفعلي أنه غير موثوق دائماً (سعته محدودة ومشتركة مع تطبيقات أخرى حول
// العالم) — أول شيء يُتحقَّق منه عند تكرار شكوى "الصوت لا يعمل بين شبكات مختلفة"
